    ...
    while (  fscanf(file_stream, "%d", &minute)!= EOF ){
        ...
        while ( get_char != '\n'){
            ...
            fscanf(file_stream, "%d%s%d%d", 
                &list_of_records[number_of_records].get_wheelbarrow_number(), list_of_records[number_of_records].get_stone_name(),
                &list_of_records[number_of_records].get_stone_weight(), &list_of_records[number_of_records].get_number_of_stones());
